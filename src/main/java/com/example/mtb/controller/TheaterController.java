...
public class TheaterController {
    ...
    @PostMapping
    public ResponseEntity<ResponseStructure<TheaterResponse>> createTheater(@RequestBody TheaterRequest request, @RequestParam String email){
    ...
    @GetMapping
    public ResponseEntity<ResponseStructure<TheaterResponse>> findByTheaterId(@RequestBody TheaterRequest request, @RequestParam String id){
