...
public class TheaterServiceImpl implements TheaterService {
    ...
    public TheaterResponse createTheater(TheaterRequest request, String email) {
        ...
        if (!(userDetails instanceof TheaterOwner)){
            throw new EmailNotExistException("User is not a theater owner");
        }
        TheaterOwner owner=(TheaterOwner) userDetails;
        return theaterMapper.toTheaterResponse(theaterRepository.save(theaterMapper.toTheater(request,email,owner)));
    }
